...
user_profile = Table('user_profile', metadata,
        ...
        Column('count_fan', INTEGER(unsigned=True), nullable=False, default=0),
        Column('count_follow', INTEGER(unsigned=True), nullable=False,
            default=0),
...
user_relation = Table('user_relation', metadata,
        ...
        Column('user_id', INTEGER(unsigned=True), ForeignKey('user_base.id'),
            nullable=False),
        Column('target_id', INTEGER(unsigned=True), ForeignKey('user_base.id'),
            nullable=False),
        Column('reverse', BOOLEAN, nullable=False, default=True),   # followed
...
user_friendsgroup = Table('user_friendsgroup', metadata,
        ...
        Column('target_id', INTEGER(unsigned=True), ForeignKey('user_base.id'),
            nullable=False),
        Column('friendtag_id', INTEGER(unsigned=True),
            ForeignKey('user_friendtag.id'), nullable=False),
...
user_mail = Table('user_mail', metadata,
        ...
        Column('user_id', INTEGER(unsigned=True), ForeignKey('user_base.id'),
            nullable=False),  # People who get mail
        Column('message_id', INTEGER(unsigned=True),
            ForeignKey('user_message.id'), nullable=False),
...
user_gallery = Table('user_gallery', metadata,
        Column('id', INTEGER(unsigned=True), primary_key=True),
        Column('user_id', INTEGER(unsigned=True), ForeignKey('user_base.id'),
            nullable=False),
...
user_image = Table('user_image', metadata,
        Column('id', INTEGER(unsigned=True), primary_key=True),
        Column('icon', BOOLEAN, nullable=False, default=0),

        Column('user_id', INTEGER(unsigned=True), ForeignKey('user_base.id'),
            nullable=False),
        Column('servname', VARCHAR(32), nullable=False, unique=True),
        Column('filetype', VARCHAR(8), nullable=False),
        Column('basename', VARCHAR(64), nullable=False),
        Column('filesize', INTEGER(unsigned=True)),
...
user_album = Table('user_album', metadata,
        Column('id', INTEGER(unsigned=True), primary_key=True),
        Column('gallery_id', INTEGER(unsigned=True), ForeignKey('user_gallery.id'),
            nullable=False),
        Column('image_id', INTEGER(unsigned=True), ForeignKey('user_image.id'),
            nullable=False),
        ...
        Column('_modified', INTEGER(unsigned=True), nullable=False,
            default=func.unix_timestamp(), onupdate=func.unix_timestamp()),
        UniqueConstraint('gallery_id', 'image_id'),
        mysql_engine = 'InnoDB',
        mysql_charset = 'utf8',
        )
...
news_detail = Table('news_detail', metadata,
        ...
        Column('category_id', INTEGER(unsigned=True),
...
news_content = Table('news_content', metadata,
        Column('id', INTEGER(unsigned=True), primary_key=True),
        Column('news_id', INTEGER(unsigned=True), ForeignKey('news_detail.id'),
            nullable=False),
...
game_content = Table('game_content', metadata,
        Column('id', INTEGER(unsigned=True), primary_key=True),
        Column('game_id', INTEGER(unsigned=True), ForeignKey('game_detail.id'),
            nullable=False),

        Column('content', TEXT),
        Column('_content', TEXT),
        Column('changelog', TEXT),
        Column('_changelog', TEXT),
...
game_genre = Table('game_genre', metadata,
        ...
        Column('game_id', INTEGER(unsigned=True), ForeignKey('game_detail.id'),
            nullable=False),
        Column('genre_id', INTEGER(unsigned=True),
            ForeignKey('game_taxonomy.id'), nullable=False),
...
game_platform = Table('game_platform', metadata,
        ...
        Column('game_id', INTEGER(unsigned=True), ForeignKey('game_detail.id'),
            nullable=False),
        Column('platform_id', INTEGER(unsigned=True),
            ForeignKey('game_taxonomy.id'), nullable=False),

        Column('price_cny', DECIMAL(precision=8, scale=2), nullable=False,
            default=0),
        Column('price_usd', DECIMAL(precision=8, scale=2), nullable=False,
            default=0),
        Column('discount', TINYINT(unsigned=True), nullable=False, index=True,
            default=100),
        Column('capacity', INTEGER(unsigned=True)),
        Column('current_version', VARCHAR(32)),
        Column('system_version', VARCHAR(1024)),
        Column('language', VARCHAR(512)),
        Column('download_site', VARCHAR(128)),
        ...
        Column('_modified', INTEGER(unsigned=True), nullable=False,
            default=func.unix_timestamp(), onupdate=func.unix_timestamp()),
        UniqueConstraint('game_id', 'platform_id'),
        mysql_engine = 'InnoDB',
        mysql_charset = 'utf8',
        )
...
game_review = Table('game_review', metadata,
        ...
        Column('count_visit', INTEGER(unsigned=True), nullable=False,
            default=0),
        Column('count_comment', INTEGER(unsigned=True), nullable=False,
            default=0),
...
game_mark = Table('game_evaluation', metadata,
        ...
        # 0=>False, unix_timestamp=>True
        Column('mark', INTEGER(unsigned=True), nullable=False, default=0),
        Column('play', INTEGER(unsigned=True), nullable=False, default=0),
        Column('like', INTEGER(unsigned=True), nullable=False, default=0),
        Column('scored', INTEGER(unsigned=True), nullable=False, default=0),
...
game_image = Table('game_image', metadata,
        Column('id', INTEGER(unsigned=True), primary_key=True),
        Column('is_gallery', BOOLEAN, nullable=False, default=0),
        Column('game_id', INTEGER(unsigned=True), ForeignKey('game_detail.id'),
            nullable=False),
        Column('image_id', INTEGER(unsigned=True), ForeignKey('user_image.id'),
            nullable=False),
...
group_apply = Table('group_apply', metadata,
        ...
        Column('dealt', BOOLEAN, nullable=False, default=0),
...
group_detail = Table('group_detail', metadata,
        ...
        Column('thumb_id', INTEGER(unsigned=True), ForeignKey('user_image.id')),
        Column('count_topic', INTEGER(unsigned=True), nullable=False,
            default=0),
        Column('count_member', INTEGER(unsigned=True), nullable=False,
            default=0),
        Column('enable_applicant_create_topic', BOOLEAN, nullable=False,
            default=1),
        Column('enable_people_create_topic', BOOLEAN, nullable=False,
            default=1),
...
group_member = Table('group_member', metadata,
        Column('id', INTEGER(unsigned=True), primary_key=True),
        Column('group_id', INTEGER(unsigned=True),
            ForeignKey('group_detail.id'), nullable=False),
        Column('user_id', INTEGER(unsigned=True), ForeignKey('user_base.id'),
            nullable=False),
        # 0=>founder, 1=>assistant, 2=>member, 3=>applicant
        Column('roles', TINYINT(unsigned=True), nullable=False, default=2),
...
group_topic = Table('group_topic', metadata,
        ...
        Column('count_reply', INTEGER(unsigned=True), nullable=False,
            default=0),
        Column('count_visit', INTEGER(unsigned=True), nullable=False,
            default=0),
        # unix_timestamp, default = created
        Column('recently_reply', INTEGER(unsigned=True), nullable=False),
        Column('headline', VARCHAR(256)),
...
group_reply = Table('group_reply', metadata,
        ...
        Column('topic_id', INTEGER(unsigned=True),
            ForeignKey('group_topic.id'), nullable=False),
        Column('user_id', INTEGER(unsigned=True), ForeignKey('user_base.id'),
            nullable=False),
...
tag_mark = Table('tag_mark', metadata,
        Column('id', INTEGER(unsigned=True), primary_key=True),
        Column('tag_id', INTEGER(unsigned=True), ForeignKey('tag_content.id'),
            nullable=False),
        Column('object_type_id', INTEGER(unsigned=True),
            ForeignKey('site_model.id'), nullable=False),
        Column('object_pk', INTEGER(unsigned=True), nullable=False),
        Column('user_id', INTEGER(unsigned=True), ForeignKey('user_base.id'),
            nullable=False),
